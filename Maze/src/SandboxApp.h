...
public:
    ...
    bool OnMousePressedEvent(Engine::MousePressedEvent & event);
    bool OnMouseReleaseEvent(Engine::MouseReleasedEvent & event);
...
private:
    ...
    std::shared_ptr<Engine::VertexArray> avatarVA;
